...
class LabelSelect extends Component {
  ...
  render() {
    ...
    return (
      <View >
      <View style={{borderWidth:1,height:40,alignItems:'center',justifyContent:'center',borderColor:'#ccc',flexDirection:'row'}}>
      <View style={{flex:0.6,marginLeft:20}}>
      <Text onPress={this.openModal} style={Styles.TitleText,titleTextStyle}>{TitleText}</Text>
      </View>
        {enable && !readOnly && enableAddBtn &&

          <TouchableHighlight
            style={[{alignItems:'center',marginRight:15,justifyContent:'center',width:20,height:20,borderRadius:10}, Styles.addItem]}
        ...
        <View style={[Styles.selectedView, style]}>{selectedLabels}</View>
        <Modal
          transparent={true}
                ...
                <View style={[Styles.modal, customStyle.modal || {}]}>
                  ...
                  <View style={[Styles.buttonView, customStyle.buttonView || {}]}>
                    ...
                    <TouchableHighlight
                      ...
                      <View style={[Styles.modalButton, Styles.confirmButton, customStyle.confirmButton,{backgroundColor:'#f00'} || {}]}>
